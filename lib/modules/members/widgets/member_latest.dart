...
class MembersLatest extends StatefulWidget {
  const MembersLatest({Key? key}) : super(key: key);

  @override
  State<MembersLatest> createState() => _MembersLatestState();
}

class _MembersLatestState extends State<MembersLatest> {
  @override
  Widget build(BuildContext context) {
    return BlocProvider<MemberCubit>(
        create: (_) => getIt<MemberCubit>()..refreshItems(),
  ...
  void _onRefresh(BuildContext context) {
    context.read<MemberCubit>().refreshItems();
  }

  void _onLoadMore(BuildContext context) {
    context.read<MemberCubit>().loadMoreItems();
  }
}
